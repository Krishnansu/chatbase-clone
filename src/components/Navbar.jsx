...
const Navbar = () => {
  ...
  <div className='flex flex-row justify-center border-b-[1px] border-gray-300'>
    ...
    <button className='mx-4 pb-2 font-medium text-gray-700 hover:text-gray-700 focus:text-gray-700 border-b-[3px] border-purple-600 focus:border-b-purple-600'>Sources</button>
