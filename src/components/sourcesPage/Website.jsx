        ...
        {links.map((link,index)=>(
          <>
            <div className='flex flex-row justify-evenly items-center my-2'>
              ...
              <input type="url" defaultValue={link} className='border border-gray-300 rounded-md w-[60%] text-base text-gray-700 px-2'></input>
              <span className='font-normal text-xs text-gray-600'>5123</span>
